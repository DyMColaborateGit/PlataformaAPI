...
namespace Qplus.Controllers.PTL
{
    ...
    public class PTLSitiosAPController
    {
        ...
        [HttpGet("GetListSitios")]
        public async Task<GetResponse<List<PTLSitiosAPModels>>> GetListSitios()
        {
            GetResponse<List<PTLSitiosAPModels>> resultado = new GetResponse<List<PTLSitiosAPModels>>();
            try
            {
                resultado.Data = await _PTLSitiosAPService.GetListSitios();
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        [HttpPut("PutModificarSitio")]
        public async Task<GetResponse<PTLSitiosAPModels>> PutModificarSitio([FromBody] PTLSitiosAPModels ObjModificarSitio)
        {
            GetResponse<PTLSitiosAPModels> resultado = new GetResponse<PTLSitiosAPModels>();
            try
            {
                resultado.Data = await _PTLSitiosAPService.PutModificarSitio(
                    ObjModificarSitio,
                    ObjModificarSitio.NombreSitio,
                    ObjModificarSitio.DescripcionSitio,
                    ObjModificarSitio.UrlSitio,
                    ObjModificarSitio.EstadoSitio,
                    ObjModificarSitio.PuertoSitio
                );
                resultado.StatusCode = (int)HttpCodes.OK;
                resultado.Message = new HttpCodesMessage().OK;
                return resultado;
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        [HttpDelete("DeleteSitio/{SitioId}")]
        public async Task<GetResponse<PTLSitiosAPModels>> DeleteSitio(int SitioId)
        {
            GetResponse<PTLSitiosAPModels> resultado = new GetResponse<PTLSitiosAPModels>();
            try
            {
                resultado.Data = await _PTLSitiosAPService.DeleteSitio(SitioId);
                resultado.StatusCode = (int)HttpCodes.OK;
                resultado.Message = new HttpCodesMessage().OK;
                return resultado;
            }
