...
{
    public class PTLSuscriptorAPConfiguration : IEntityTypeConfiguration<PTLSuscriptorAPEntities>
    {
        public void Configure(EntityTypeBuilder<PTLSuscriptorAPEntities> builder)
        {
            builder.ToTable("PTLSuscriptorAP")
