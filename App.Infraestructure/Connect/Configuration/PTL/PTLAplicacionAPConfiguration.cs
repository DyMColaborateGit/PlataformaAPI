...
{
    public class PTLAplicacionAPConfiguration : IEntityTypeConfiguration<PTLAplicacionAPEntities>
    {
        public void Configure(EntityTypeBuilder<PTLAplicacionAPEntities> builder)
        {
            builder.ToTable("PTLAplicacionAP")
